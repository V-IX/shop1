...
class Comments_model extends CI_Model {
	...
	{
		$this->query->select('shop_products_comments.*, shop_products.title, shop_products.articul, shop_products.img');
	...
	public function insert()
	{
		...
		if($error)
		{
			...
			set_flash('result', action_result('success', fa('check mr5').' Запись <span class="medium">"'.$insert['name'].' - '.$insert['city'].'"</span> успешно создана!', true));
			return false;
		}
	}
