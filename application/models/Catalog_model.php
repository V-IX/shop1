...
class Catalog_model extends CI_Model {
	...
	public function getItemsTree($limit = false, $offset = false, $order = false, $params = array(), $current = false)
	{
		...
		$query = $this->getItems($limit, $offset, $order, $params, 'idItem, idParent, title, alias, img, visibility, tmenu, home');
...
//var_dump ($breadcrumbs);		
	...
	public function post()
	{
		...
		if(array_key_exists('tmenu', $return)) $return['tmenu'] = $return['tmenu'] ? 1 : 0;
		else $return['tmenu'] = 0;
