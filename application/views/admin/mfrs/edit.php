...
<div class="row form-group">
	...
	<div class="col-9 form-colinput">
		<input type="text" class="form-input" name="slider_num" value="<?=set_value('slider_num', $item['slider_num']);?>" />
		<?=form_error('slider_num'); ?>
	</div>
</div>
<div class="row form-group">
	<div class="col-3 form-collabel _nopadding">
	...
	<div class="col-9 form-colinput">
		<input type="checkbox" name="slider" <?=$item['slider'] == 1 ? 'checked' : '';?> />
		<?=form_error('slider'); ?>
	</div>
</div>
