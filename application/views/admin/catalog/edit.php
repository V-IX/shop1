...
<div class="row form-group">
	<div class="col-3 form-collabel">
		Номер по порядку (меню)
		<div class="h6 text-gray">На сайте выводится в обратном порядке</div>
	</div>
	<div class="col-9 form-colinput">
		<input type="text" class="form-input" name="tmenu_num" value="<?=set_value('tmenu_num', $item['tmenu_num']);?>" />
		<?=form_error('tmenu_num'); ?>
	</div>
</div>
<div class="row form-group">
	<div class="col-3 form-collabel _nopadding">
	...
	<div class="col-9 form-colinput">
		<input type="checkbox" name="tmenu" <?=$item['tmenu'] == 1 ? 'checked' : '';?> />
		<?=form_error('tmenu'); ?>
	</div>
</div>
